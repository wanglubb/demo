...
public class ChaoJiYing {
    ...
    public static String PostPic_base64(String file_base64) throws ApiException {
        ...
        String s = "user=gongjin2023&pass=gongjin2023&softid=953987&codetype=4004&len_min=4&file_base64=" + file_base64;
